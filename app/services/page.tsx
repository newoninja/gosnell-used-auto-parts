    ...
    <main className="min-h-screen">
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-5xl px-4 py-14 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-3 font-heading text-4xl font-black text-slate-900 sm:text-5xl">What we do</h1>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 rounded-lg border border-orange-200 bg-orange-50 p-5">
          ...
          <a
            ...
            className="mt-3 inline-flex items-center gap-2 rounded-md bg-orange-500 px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-orange-400"
          >
