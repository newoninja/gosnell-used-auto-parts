    ...
    <main className="min-h-screen">
      <section className="border-b border-slate-200 bg-white">
        <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8 lg:py-20">
          ...
          <h1 className="mt-3 max-w-3xl font-heading text-4xl font-black leading-tight text-slate-900 sm:text-5xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <a
              ...
              className="rounded-lg bg-orange-500 px-5 py-3 text-sm font-bold text-white transition-colors hover:bg-orange-400"
            >
              Search Inventory
            </a>
            <a
              href={BUSINESS.phones.mainHref}
              className="rounded-lg border border-slate-300 bg-white px-5 py-3 text-sm font-bold text-slate-900 transition-colors hover:bg-slate-100"
            >
